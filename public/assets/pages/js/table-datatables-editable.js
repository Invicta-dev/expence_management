    ...
    var handleDashTable = function () {
       ...
       //ajax call to controller method to fetch process and category for edit option
        $.get( window.location.href+'/ajax-call', function(data) {
            ...
            var aData = oTable.fnGetData(nRow);
            var jqTds = $('>td', nRow);
            //my code to extract inner text from anchor tag for vendor column
            var str =aData[2];
            var results = [];
           $(str).each(function(l) {
            ...
            //ends
            jqTds[0].innerHTML = '<input type="text" id="unique" class="form-control input-small" value="' + aData[0] +'">';
            jqTds[1].innerHTML = '<input type="text" id="user" class="form-control input-small" value="' + aData[1] +'" disabled>';
            jqTds[2].innerHTML = '<input type="text" id="expense" class="form-control input-small" value="' + results +'">';
            jqTds[3].innerHTML = '<select id="process" class="form-control"><option value="'+aData[3]+'">'+aData[3]+'</option></select>';
            jqTds[4].innerHTML = '<select id="category" class="form-control"><option  value="'+aData[4]+'">'+aData[4]+'</option></select>';
            jqTds[5].innerHTML = '<select id="currency"  class="form-control"><option value="' + aData[5] + '" hidden>'+aData[5]+' <option value="₹">₹</option></select>';
            jqTds[6].innerHTML = '<select id="payment_mode"  class="form-control"><option value="' + aData[6] + '" hidden>'+aData[6]+'<option value="cash">Cash</option><option value="bank transfer">Bank Transfer</option><option value="Credit card">Credit card</option></select>';
            jqTds[7].innerHTML = '<input type="text" id="amount"  class="form-control input-small" value="' + aData[7] + '">';
            jqTds[8].innerHTML = '<input type="file" id="img"  name="UploadedImage[]" class="form-control" multiple>';
            jqTds[9].innerHTML = '<input type="text" id="date" class="form-control input-medium" value="' + aData[9] +'" disabled>';
            jqTds[10].innerHTML = '<a class="edit" onclick="edit_expense()">Save</a> <a class="cancel" href="">Cancel</a>';
