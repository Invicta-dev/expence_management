var TableDatatablesEditable = function () {
    ...
    var handleDashTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            var jqTds = $('>td', nRow);
            jqTds[0].innerHTML = '<input type="text" id="unique" class="form-control input-small" value="' + aData[0] +'">';
            jqTds[1].innerHTML = '<input type="text" id="unique" class="form-control input-small" value="' + aData[1] +'">';
            jqTds[2].innerHTML = '<select class="form-control"><option>Option 1</option><option>Option 2</option><option>Option 3</option></select>';
            jqTds[3].innerHTML = '<select class="form-control"><option>Option 1</option><option>Option 2</option><option>Option 3</option></select>';
            jqTds[4].innerHTML = '<input type="text" id="role"  class="form-control input-small" value="' + aData[4] + '">';
            jqTds[5].innerHTML = '<input type="file" name="..." id="fileinput" class="form-control input-small" value"">';
            jqTds[6].innerHTML = '<input type="text" class="form-control form-control-inline input-small date-picker" value="' + aData[6] + '">';
            jqTds[7].innerHTML = '<a class="edit" onclick="edit_user()">Save</a> <a class="cancel" href="">Cancel</a>';
