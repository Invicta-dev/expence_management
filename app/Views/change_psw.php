            ...
            <form class="login-form" action="<?= base_url(); ?>/set_password" method="post">
                ...
                <?php if (session()->has('validation')) : ?>
                    <div class="alert alert-danger ">
                        ...
                        <div> <?= session()->getFlashdata('validation')->getError('confirm'); ?> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirm Password" name="confirm" /> </div>
                </div>
